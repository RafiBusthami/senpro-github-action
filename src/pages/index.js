 import Head from 'next/head'//ini
 import Image from 'next/image'//adalah
 import { Inter } from '@next/font/google'//komentar
 import styles from '@/styles/Home.module.css'//ini 
